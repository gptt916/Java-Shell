...
public class History{
  public int numberOfCommands =1;
  // create a List of String to hold the inputs
  static ArrayList<String> history_array = new ArrayList<String>();  
...
//  }
   ...
   * input into JShell)
   */
   public static String ExclamationEntry(int number)
   {
     return history_array.get(number-1);
   }
